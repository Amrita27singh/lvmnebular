...
plt.plot(vals[0], data[93, 2:], label='H_alpha_vs_true R')
plt.plot(vals[0], data[66, 2:], label='H_beta_vs_true R')
plt.plot(vals[0], data[73, 2:], label='[OIII_5007]_vs_true R')
plt.plot(vals[0], data[71, 2:], label='[OIII_4959]_vs_true R')
plt.xlabel('R(pc)')
plt.ylabel('Emissivity')
plt.legend()

fig, ax=plt.subplots()
ax.plot(vals[0], vals[8]*6.67e-5*1e2, label='n[NII]_vs_true R')
