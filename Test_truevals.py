...
hdu=fits.open('./lvmnebular/Bubble_v2_5e-14/testneb_tutorial3_ex1.fits')
vals=hdu['Comp_0_PhysParams'].data

print(vals[9], vals[6],vals[5])
print(np.mean(vals[9]), np.mean(vals[6]), np.mean(vals[5]))
table=Table(vals)
table.write('./lvmnebular/True_vals.fits', overwrite=True)
#print(table)
...
plt.savefig('./lvmnebular/Bubble_v2_5e-14/Bubble_v2_5e-14_plotprofile/Te vs R.png', dpi=300)
plt.show()
...
plt.savefig('./lvmnebular/Bubble_v2_5e-14/Bubble_v2_5e-14_plotprofile/ne vs R.png', dpi=300)
plt.show()
...
plt.savefig('./lvmnebular/Bubble_v2_5e-14/Bubble_v2_5e-14_plotprofile/nO vs R.png', dpi=300)
plt.show()
...
plt.savefig('./lvmnebular/Bubble_v2_5e-14/Bubble_v2_5e-14_plotprofile/nN vs R.png', dpi=300)
plt.show()
...
plt.savefig('./lvmnebular/Bubble_v2_5e-14/Bubble_v2_5e-14_plotprofile/nS vs R.png', dpi=300)
plt.show()
