...
#simname = np.array(['Bubble_v2_1e-8_z_0.8', 'Bubble_v2_5e-14_z_0.8'])
        ...
        u.chem_abund(line)
        u.chem_abund_emperical(line)
        u.Te_Abund_plot(u.linefitdict['TeS3'], u.vals[12], u.int_TS3, u.int_SppH, u.SppH, u.Abund_S3,  testline = np.array(line), z = z1, log_ion_sun = -4.88, rad1 = 17.35, rad2 = 18, label = '[SIII]', outfilename = 'S3_Te_chem_abund_vs_R_present.png')
